...
data=load("../exm/data/Kitaev_eigenm3n4.jld", "vals","vecs")

data=load("../exm/data/Kitaev_eigenm3n3.jld", "vals","vecs")


Heven = kitaev_hamiltonian_sparse(2, 4)
valseven,vecseven = eigs(Heven, nev=10, which=:SR)
save("../exm/data/Kitaev_eigenm2n4.jld", "vals",valseven, "vecs", vecseven)
